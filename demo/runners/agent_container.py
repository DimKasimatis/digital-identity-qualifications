...
def arg_parser(ident: str = None, port: int = 8020):
    ...
    "ident", if specified, refers to one of the standard demo personas - alice, ndia, initech or performance.
    """
    ...
    if (not ident) or (ident != "alice"):
        parser.add_argument(
            ...
            action="store_true",
            help=(
                "Reuse connections by using Ndia public key in the invite. "
